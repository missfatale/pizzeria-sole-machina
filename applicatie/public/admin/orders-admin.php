...
<head>
  ...
  <link rel="stylesheet" href="../../assets/css/orders-admin.css">
</head>
...
<body>
  ...
  <header id="header">
    <nav id="hamburger-navigation">
      <div id="hamburger-menu-toggle">
        ...
        <ul id="hamburger-menu-list">
          ...
          <li><a href="../../pages/frontend/acties.html">Acties</a></li>
          <li><a href="../../pages/frontend/pizza.html">Pizza</a></li>
          <li><a href="../../pages/frontend/focaccia.html">Focaccia</a></li>
          <li><a href="../../pages/frontend/dranken.html">Dranken</a></li>
          <li><a href="../../pages/frontend/privacyverklaring.html">Privacyverklaring</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="header-flex-container bg-primary-colour-scheme">
      <div class="header-buttons bg-primary-colour-scheme">
        <a href="orders-admin.html" class="bg-primary-colour-scheme">Admin</a>
      </div>

      <div class="header-cart bg-primary-colour-scheme">
        <a href="../../pages/frontend/cart.html" class="bg-primary-colour-scheme"><i
  ...
  <!-- Main content -->
  <main id="main-orders-admin">
    <div class="flex-container pagina-titel order-recent">
      <h1>Recente order</h1>
    </div>
    ...
    <div class="flex-container flex-container-cart">
      ...
      <section id="section-latest-order">
        ...
        <div class="cart-item cart-header">
          <div class="flex-container pagina-titel bg-white order-status">
            ...
            <select id="status" name="status" required>
              <option value="" disabled selected>Selecteer de Status</option>
              <option value="voorbereid">Wordt voorbereid</option>
        ...
        <div class="cart-item-information bg-white order-details">
          <p>Order ID: 204</p>
          <p>Adres: Ruitenberglaan 31</p>
        </div>
  ...
  <footer class="bg-primary-colour-scheme">
    <div class="footer-navbar bg-primary-colour-scheme hidden">
      <a class="text-primary-colour bg-primary-colour-scheme"
        href="../../pages/frontend/privacyverklaring.html">Privacyverklaring</a>
    </div>
