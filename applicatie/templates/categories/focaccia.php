...
<head>
  ...
  <title>Pizzeria Sole Machina - Focaccia</title>
    ...
    <nav id="hamburger-navigation">
      <div id="hamburger-menu-toggle">
        ...
        <ul id="hamburger-menu-list">
          ...
          <li><a href="focaccia.html">Focaccia</a></li>
  ...
  <main id="main-focaccia">
    ...
    <div class="grid-container">
      <article class="grid-item">
        <img src="../../assets/images/focaccia/focaccia.jpg" alt="Huisgemaakte foaccia">
        <h3>Focaccia</h3>
        <p>Onze house speciale focaccia met tomatensaus, mozzarella en peterselie.</p>
        <div class="flex-container bg-white">
          <p class="horizontal-flex-start-self">€ 6.99</p>
